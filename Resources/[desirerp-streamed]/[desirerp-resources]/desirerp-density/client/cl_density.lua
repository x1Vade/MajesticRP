...
AddEventHandler('desirerp-gopro:activateVRChair', function ()
  density = 0.0
  print('pausing polulation', density)
end)

AddEventHandler("desirerp-ui:application-closed", function(name)
  if name ~= "gopros" then return end

  density = Config.populationDensity
end)

AddEventHandler('desirerp-density:disable', function (pDensity, pRogue)
