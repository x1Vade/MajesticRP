...
AddEventHandler('desirerp-config:configLoaded', function (pId)
    if (pId ~= 'desirerp-density') then return end
                ...
                if inside and not Ghosted[vehicle] then
                    ...
                    if not isPlayer then
                        ...
                        if Config.antiGhostYeetVehicles then
                            TriggerEvent('desirerp-density:yeet', vehicle)
                        end
                    end
...
AddEventHandler('desirerp-density:yeet', function (vehicle)
    local vin = exports['desirerp-vehicles']:GetVehicleIdentifier(vehicle)

    if vin then return end

    exports['desirerp-sync']:SyncedExecution('DeleteEntity', vehicle)
end)
