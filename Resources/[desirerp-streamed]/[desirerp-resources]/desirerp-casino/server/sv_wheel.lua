...
RegisterServerEvent('desirerp-luckywheel:getLucky')
AddEventHandler('desirerp-luckywheel:getLucky', function(money)
    local src = source
        ...
        if user ~= nil then
            ...
            SetTimeout(5000, function()
                ...
                if _priceIndex == 1 or _priceIndex == 9 or _priceIndex == 13 or _priceIndex == 17 then
                    ...
                    TriggerClientEvent('desirerp-casino:addBalance', src, '500')
                elseif _priceIndex == 2 or _priceIndex == 6 or _priceIndex == 10 or _priceIndex == 14 or _priceIndex == 18 then
                    ...
                    TriggerClientEvent('desirerp-casino:giveChipsCL', source, _money3)
                ...
                TriggerClientEvent("desirerp-luckywheel:rollFinished", -1)
            end)
            TriggerClientEvent("desirerp-luckywheel:doRoll", -1, _priceIndex)
        end
    end
end)
...
RegisterServerEvent("attempt:spin", function()
    local pSrc = source
    if CasinoSpin then
        TriggerClientEvent("desirerp-luckywheel:spinit", pSrc, true)
    else
