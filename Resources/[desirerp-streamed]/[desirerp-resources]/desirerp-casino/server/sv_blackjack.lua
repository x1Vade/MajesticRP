    ...
    if gameId ~= nil and betAmount ~= nil and chairId ~= nil then 
        ...
        if not blackjackGameInProgress[gameId] then
            if tonumber(betAmount) then
                ...
                if betAmount > 0 then
                    TriggerClientEvent('desirerp-casino:removeChipsCL', source, betAmount)
                                            ...
                                            if currentHand <= 21 then
                                                ...
                                                if dealerHand > 21 then
                                                    ...
                                                    local connect = {
                                                        {
                                                          ["color"] = color,
                                                          ["title"] = "** DesireRP [Casino] | Blackjack **",
                                                    ...
                                                    TriggerClientEvent('desirerp-casino:giveChipsCL', source, potentialWinAmount)
