...
AddEventHandler("desirerp-inventory:itemUsed", function(pItem)
    if pItem == "thermitecharge" then
        TriggerEvent('desirerp-vault:firstdoor')
        TriggerEvent('desirerp-vault:seconddoor')
        TriggerEvent('desirerp-vault:lowerfirstdoor')
        TriggerEvent('desirerp-vault:lowerseconddoor')
    elseif pItem == "heistlaptop4" then
        TriggerEvent('desirerp-vault:startlowervault')
        TriggerEvent('desirerp-vault:startvault')
    end
end)

RegisterNetEvent('desirerp-vault:firstdoor')
AddEventHandler('desirerp-vault:firstdoor', function()
    ...
    if pd >= 4 then
        if distance < 1.5 then
            if exports["desirerp-inventory"]:hasEnoughOfItem("thermitecharge", 1) then
                TriggerServerEvent('desirerp-heists:vaultRobberyLog')
                TriggerEvent('desirerp-dispatch:pacific-robbery')
                TriggerEvent("client:newStress",true, 150)
                frontdoorvault()
                TriggerEvent('desirerp-dispatch:bankrobbery')
                exports['desirerp-thermite']:OpenThermiteGame(function(success)
                    if success then
                        TriggerEvent("inventory:removeItem", "thermitecharge", 1)
                        TriggerServerEvent('desirerp-doors:change-lock-state', 46, false) 
                        Citizen.Wait(3000)
...
RegisterNetEvent('desirerp-vault:seconddoor')
AddEventHandler('desirerp-vault:seconddoor', function()
    local player = GetEntityCoords(PlayerPedId())
            ...
            if exports["desirerp-inventory"]:hasEnoughOfItem("thermitecharge", 1) then
                ...
                exports['desirerp-thermite']:OpenThermiteGame(function(success)
                    if success then
                        ...
                        TriggerEvent("inventory:removeItem", "thermitecharge", 1)
                        TriggerServerEvent('desirerp-doors:change-lock-state', 48, false) 
                        Citizen.Wait(3000)
                        FreezeEntityPosition(PlayerPedId(), false)
                    else
                        TriggerEvent('inventory:removeItem', 'thermitecharge', 1)
...
RegisterNetEvent('desirerp-vault:startvault')
AddEventHandler('desirerp-vault:startvault', function()
    local player = GetEntityCoords(PlayerPedId())
    local distance = #(vector3(253.25254, 228.45343, 101.68377) - player)
    local pd = RPC.execute("desirerp-police:getActiveUnits")
    if pd >= 4 then
        if distance < 1.5 then
            if exports["desirerp-inventory"]:hasEnoughOfItem("heistlaptop4", 1) then
                TriggerEvent('desirerp-dispatch:pacific-robbery')
                StartVaultKid()
                TriggerEvent('desirerp-dispatch:bankrobbery')
                TriggerEvent("client:newStress",true, 150)
                exports['desirerp-hacking']:hacking(
                function()
                    ClearPedTasksImmediately(PlayerPedId())
                    TriggerEvent('desirerp-heists:vault_door')
                    DeleteObject(bag)
                    DeleteObject(laptop)
...
RegisterNetEvent('desirerp-heists:vault_door')
AddEventHandler('desirerp-heists:vault_door', function()
    TriggerEvent('vault:success:panel', closestBank, true)
    CreatenBrakeCrates()
end)

RegisterNetEvent('desirerp-vault:lowerfirstdoor')
AddEventHandler('desirerp-vault:lowerfirstdoor', function()
    local player = GetEntityCoords(PlayerPedId())
            ...
            if exports["desirerp-inventory"]:hasEnoughOfItem("thermitecharge", 1) then
                ...
                exports['desirerp-thermite']:OpenThermiteGame(function(success)
                    if success then
                        ...
                        TriggerEvent("inventory:removeItem", "thermitecharge", 1)
                        TriggerServerEvent('desirerp-doors:change-lock-state', 49, false) 
                        Citizen.Wait(3000)
                        FreezeEntityPosition(PlayerPedId(), false)
                    else
                        TriggerEvent('inventory:removeItem', 'thermitecharge', 1)
...
RegisterNetEvent('desirerp-vault:lowerseconddoor')
AddEventHandler('desirerp-vault:lowerseconddoor', function()
    local player = GetEntityCoords(PlayerPedId())
            ...
            if exports["desirerp-inventory"]:hasEnoughOfItem("thermitecharge", 1) then
                ...
                exports['desirerp-thermite']:OpenThermiteGame(function(success)
                    if success then
                        ...
                        TriggerEvent("inventory:removeItem", "thermitecharge", 1)
                        TriggerServerEvent('desirerp-doors:change-lock-state', 50, false) 
                        Citizen.Wait(3000)
                        FreezeEntityPosition(PlayerPedId(), false)
                    else
                        TriggerEvent('inventory:removeItem', 'thermitecharge', 1)
...
RegisterNetEvent("desirerp-vault:grab", function()
...
exports["desirerp-polytarget"]:AddCircleZone("desirerp_vault_lower_interact_1",  vector3(289.29, 227.55, 98.24), 0.25, {
    useZ = true
})

exports["desirerp-polytarget"]:AddCircleZone("desirerp_vault_lower_interact_2",  vector3(286.92, 227.39, 98.29), 0.2, {
    useZ = true
})

exports["desirerp-polytarget"]:AddCircleZone("desirerp_vault_lower_interact_3", vector3(284.69, 221.64, 98.24), 0.2, {
    useZ = true
})

exports["desirerp-polytarget"]:AddCircleZone("desirerp_vault_lower_interact_4", vector3(286.52, 220.06, 98.29), 0.25, {
    useZ = true
})


exports["desirerp-interact"]:AddPeekEntryByPolyTarget("desirerp_vault_lower_interact_1", {{
    event = "desirerp-vaultrob:lower:firstpindoor",
...
exports["desirerp-interact"]:AddPeekEntryByPolyTarget("desirerp_vault_lower_interact_2", {{
    event = "desirerp-vaultrob:lower:secpindoor",
...
exports["desirerp-interact"]:AddPeekEntryByPolyTarget("desirerp_vault_lower_interact_3", {{
    event = "desirerp-vaultrob:lower:thirdpindoor",
...
exports["desirerp-interact"]:AddPeekEntryByPolyTarget("desirerp_vault_lower_interact_4", {{
    event = "desirerp-vaultrob:lower:fourthpindoor",
...
RegisterNetEvent('desirerp-loot_gold_tray')
AddEventHandler('desirerp-loot_gold_tray', function()
    TriggerServerEvent('desirerp-heists:loot_tray')
end)

RegisterNetEvent('desirerp-loot_cash_tray')
AddEventHandler('desirerp-loot_cash_tray', function()
    TriggerServerEvent('desirerp-heists:cash_tray')
end)

RegisterNetEvent("desirerp-heists:grab_from_tray")
AddEventHandler("desirerp-heists:grab_from_tray", function()
    local chance = math.random(120)
    Loot()
    if chance < 25 then
