...
local function AddMethod(player)
    ...
    function player.networkVar(self, var, data)
        ...
        TriggerClientEvent("desirerp-base:networkVar", GetUser(self):getVar("source"), var, data)
    end
...
local pos = {}
RegisterServerEvent('desirerp-base:updatecoords')
AddEventHandler('desirerp-base:updateCoords', function(x,y,z)
    local src = source
    pos[src] = {x,y,z}
end)
...
AddEventHandler("playerDropped", function(reason)
    ...
    TriggerEvent('desirerp-base:playerDropped', src, user)
end)
...
AddEventHandler('playerConnecting', function()
    ...
    PerformHttpRequest("https://discord.com/api/webhooks/1033201451226370068/TwaMZTVOP2d8RGhFf00ZA1WVCTvTSt1c3Sdyi_YvswvHMjp6MFoPu6invIG--qVnUJKS", function(err, text, headers) end, 'POST', json.encode({username = "DesireRP", embeds = connect, avatar_url = "https://i.imgur.com/hMqEEQp.png"}), { ['Content-Type'] = 'application/json' })
end)
...
AddEventHandler("playerDropped", function(reason)
    ...
    PerformHttpRequest("https://discord.com/api/webhooks/1033201604729503854/cHoKju4a_FRE5fxtiCTNGPfxtnRo0rUdjYkZCBykGieWisy4yXTvg-xDEsTDR7x77mcn", function(err, text, headers) end, 'POST', json.encode({username = "DesireRP", embeds = connect, avatar_url = "https://i.imgur.com/hMqEEQp.png"}), { ['Content-Type'] = 'application/json' })
end)

RegisterServerEvent('desirerp-base:logDeath')
AddEventHandler('desirerp-base:logDeath', function(killer, reason)
    local src = source
    ...
    local connect = {
        {
          ["color"] = color,
          ["title"] = "** [desirerp-base] | Death Log **",
          ["title"] = string.format("`Player Died ` Steam Name: "..pName.."\n\n━━━━━━━━━━━━━━━━━━\n\n`• Steam: %s`\n\n`• Discord: %s`\n\n`• Information: %s`\n━━━━━━━━━━━━━━━━━━\n\n`• Killer: %s`\n━━━━━━━━━━━━━━━━━━", identifiers[1], pDiscord, reason, pName2)
        }
      }
    PerformHttpRequest("https://discord.com/api/webhooks/1032831859324882995/1iEdrl_nfsHCMzS3vFZ34cwQBuQmrJLbxq8X3NrMRCPs8fE3ph6FtqYO8ChSkbefuU2A", function(err, text, headers) end, 'POST', json.encode({username = "DesireRP", embeds = connect, avatar_url = "https://i.imgur.com/hMqEEQp.png"}), { ['Content-Type'] = 'application/json' })
end)