...
RegisterNUICallback('payCheckEmployee', function(data)
    ...
    local paid = RPC.execute('desirerp-phone:business_paycheck', business,cid,amount)
end)
...
RegisterNUICallback('btnTaskGroups', function()
  ...
  RegisterNUICallback("editBusinessRole", function(data)
    if data.pCurRole == "Owner" then
      TriggerEvent('DoLongHudText', 'You cannot edit the owner role.', 2)
      return
    end
