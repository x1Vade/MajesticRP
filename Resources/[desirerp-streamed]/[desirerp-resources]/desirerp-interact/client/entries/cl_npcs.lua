    ...
    data = {
        {
            ...
            icon = "fas fa-circle",
            event = "desirerp-npcs:ped:keeper",
            parameters = { "2" }
        }
    },
    options = {
    ...
    data = {
        {
            ...
            label = "Start Job",
            icon = "fas fa-circle",
            event = "desirerp-jobs:garbagestart:menu",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            label = "Sign In/Out",
            icon = "fas fa-circle",
            event = "desirerp-chopshop:clock-in",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "fas fa-circle",
            event = "desirerp-license:purchaseBusinessLicense",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            label = "Package Goods",
            icon = "fas fa-user-secret",
            event = "desirerp-weed:preparePackage",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            label = "Open Shop",
            icon = "circle",
            event = "desirerp-npcs:ped:openDigitalDenShop",
        }
    },
    options = {
        distance = { radius = 2.5 },
    ...
    data = {
        {
            ...
            label = "Trade",
            icon = "recycle",
            event = "desirerp-npcs:ped:exchangeRecycleMaterial",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            label = "Sell Fish",
            icon = "fish",
            event = "desirerp-npcs:ped:sellFish",
            parameters = {}
        }
    },
    options = {
...
Entries[#Entries + 1] = {
    ...
    options = {
        ...
        isEnabled = function(entity)
            return not IsPedAPlayer(entity) and exports["desirerp-polyzone"]:IsInsideEvent(entity)
        end
    }
}
    ...
    data = {
        {
            ...
            icon = "circle",
            event = "desirerp-houserobberies:sell_goods",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "circle",
            event = "desirerp-heists:interactBobcatC4Npc",
            parameters = {},
        },
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "circle",
            event = "desirerp-npcs:ped:giveStolenItems",
            parameters = {}
        },
        {
            id = "pawn_sell_items",
            ...
            icon = "circle",
            event = "desirerp-npcs:ped:sellStolenItems",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
      {
          ...
          label = "Buy Chips",
          icon = "fas fa-circle",
          event = "desirerp-casino:purchaseChipsAction",
          parameters = { "purchase" }
      },
      {
  ...
  data = {
    {
        ...
        icon = "fas fa-circle",
        event = "desirerp-casino:purchaseMembershipCard",
        parameters = {}
    },
  },
  options = {
  ...
  data = {
    {
        ...
        icon = "fas fa-circle",
        event = "desirerp-casino:purchaseDrinks",
        parameters = {}
    },
  },
  options = {
    ...
    data = {
      {
          ...
          icon = "fas fa-clock",
          event = "desirerp-heists:checkAvailability",
          parameters = {}
      },
    },
    options = {
    ...
    data = {
      {
          ...
          event = "desirerp-heists:purchaseHeistEquipment",
          parameters = {}
      },
    },
    options = {
    ...
    data = {
        {
            ...
            label = "Rent a Boat",
            icon = "circle",
            event = "desirerp-fishing:rentBoat",
        },
        {
            id = "fish_return",
            label = "Return the Boat",
            icon = "circle",
            event = "desirerp-fishing:returnBoat",
        }
    },
    options = {
        distance = { radius = 3.0 }
    ...
    data = {
        {
            ...
            label = "Get a Boat",
            icon = "circle",
            event = "desirerp-scuba:checkAndTakeDepo",
        }
    },
    options = {
        distance = { radius = 3.0 }
...
local validAnimalModels = {
    ...
    data = {
        {
            ...
            label = "Pet",
            icon = "fas fa-circle",
            event = "desirerp-interact:doPettingAnimal",
            parameters = "petting",
        },
    },
    options = {
  ...
  AddEventHandler("desirerp-interact:doPettingAnimal", function()
