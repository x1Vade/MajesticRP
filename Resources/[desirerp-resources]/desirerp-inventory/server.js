...
onNet("desirerp-inventory:exploiterKick", async() => {
    ...
    //     {
    //         ["color"] = color,
    //         ["title"] = "** DesireRP [Inventory] | Exploiter **",
    //         ["description"] = "Steam Name: "..source.." Was kicked for attempting to use an inventory exploit.",
    //     }
    // },
    // PerformHttpRequest("https://discord.com/api/webhooks/1001461201819152404/q46crXpAJ4NZCzYRHS1b9xzHpwjCey_DqpsTOpIQfPoEAWXjwiQKn6RgIOXDKjFYOfoj", function(color, title, headers){ end }, 'POST', json.encode({username = "DesireRP | Exploiter Log", embeds = connect, avatar_url = "https://i.imgur.com/hMqEEQp.png"}), { ['Content-Type'] : 'application/json' })
});
...
function removecash(src, amount) {
    emit('desirerp-inventory:cash:remove', src, amount)
}
