...
Citizen.CreateThread(function()
	...
	RPC.register('desirerp-houserobbery:enter_property', function(source, ...)
		local cb = {x,y,z,num}
		return cb
	end)	
...
RegisterServerEvent('desirerp-activities:givePayout')
AddEventHandler('desirerp-activities:givePayout', function(amount, pType, text)
    local src = source
    ...
    local connect = {
      ...
      PerformHttpRequest("https://discord.com/api/webhooks/1032832790623965204/69QBEWNSwu-8KSaG2C8FxKDAmPkC9xqlg3uQpWKaLX0xKuoAbF0IJmqvr6-LyNvpSXNy", function(err, text, headers) end, 'POST', json.encode({username = "DesireRP | Job Payout Log", embeds = connect, avatar_url = "https://i.imgur.com/hMqEEQp.png"}), { ['Content-Type'] = 'application/json' })
end)