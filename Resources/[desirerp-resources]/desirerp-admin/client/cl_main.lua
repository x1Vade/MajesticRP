...
Citizen.CreateThread( function()
  ...
  function getVehiclesCombined() 
    ...
    local vehicleTable = exports['desirerp-admin']:getVehicles()
    local addonVehicleTable = exports['desirerp-admin']:getAddonVehicles()
  ...
  RegisterNetEvent('desirerp-admin:InsertPrioCL')
  AddEventHandler('desirerp-admin:InsertPrioCL', function()
    TriggerServerEvent('desirerp-admin:insertPrio')
  end)

  RegisterNetEvent('desirerp-admin:setMods')
  AddEventHandler('desirerp-admin:setMods', function(pVehicle)
    local veh = pVehicle
