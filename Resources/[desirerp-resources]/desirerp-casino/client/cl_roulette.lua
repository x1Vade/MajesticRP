...
-- RegisterNetEvent('desirerp-casino:setBalance')
-- AddEventHandler('desirerp-casino:setBalance', function() 
--     SendNUIMessage({action = 'setCurrentChips', amount = exports["desirerp-inventory"]:getQuantity("redchip") })
-- end)
...
--                         local keyboard = exports["desirerp-dialog"]:KeyboardInput({
--                             header = "Place Bet", 
...
--             Citizen.Wait(1500)
--         else
--             TriggerServerEvent('desirerp-roulette:notUsing', selectedRoulette)
...
--                                                     TriggerServerEvent('desirerp-roulette:taskBetRoulette', selectedRoulette, aimingAtBet, currentBetAmount)
--                                                 else
...
--     TriggerEvent('desirerp-casino:events:entered')
-- end)

-- AddEventHandler('desirerp-casino:events:entered', function()
...
-- RegisterNetEvent('desirerp-roulette:isSeatUsed')
-- AddEventHandler('desirerp-roulette:isSeatUsed', function(data, a1)
--     local k = data['k']
...
-- AddEventHandler('desirerp-casino:roulette:selectChair', function(data)
--     local entity = data.entity
--     if exports['desirerp-casino']:inCasino() then
...
--                             if exports['desirerp-inventory']:hasEnoughOfItem('casinovip', 1) then
--                                 TriggerServerEvent('desirerp-roulette:isSeatUsed', { k = k, closestChairData = closestChairData.chairId}, closestChairData)
--                             else
...
--         TriggerServerEvent('desirerp-roulette:taskStartRoulette', index, chairId)
--     end
-- end

-- RegisterNetEvent('desirerp-roulette:openRoulette')
-- AddEventHandler('desirerp-roulette:openRoulette',function(rouletteIndex)
...
-- RegisterNetEvent('desirerp-roulette:startSpin')
-- AddEventHandler(
--     'desirerp-roulette:startSpin',
...
-- RegisterNetEvent('desirerp-roulette:updateStatus')
-- AddEventHandler('desirerp-roulette:updateStatus', function(rouletteIndex, time, status)
...
-- RegisterNetEvent('desirerp-roulette:updateTableBets')
-- AddEventHandler('desirerp-roulette:updateTableBets', function(rouletteIndex, bets)
--     if Roulettes[rouletteIndex] ~= nil then
...
-- RegisterNetEvent('desirerp-roulette:updateChips')
-- AddEventHandler('desirerp-roulette:updateChips', function()
--     SendNUIMessage({action = 'setCurrentChips', amount = exports["desirerp-inventory"]:getQuantity("redchip")})
-- end)
...
-- RegisterNetEvent('desirerp-roulette:playBetAnim')
-- AddEventHandler('desirerp-roulette:playBetAnim', function(chairId)
--     local sex = 0
...
-- RegisterNetEvent('desirerp-roulette:playWinAnim')
-- AddEventHandler('desirerp-roulette:playWinAnim', function(chairId)
--     local rot = CURRENT_CHAIR_DATA.rotation
...
-- RegisterNetEvent('desirerp-roulette:playLossAnim')
-- AddEventHandler('desirerp-roulette:playLossAnim', function(chairId)
--     local rot = CURRENT_CHAIR_DATA.rotation
