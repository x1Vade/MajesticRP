...
--     local p = promise.new()
--     local player = exports["desirerp-base"]:getModule("Player"):GetUser(source)
--     if player then
--         TriggerClientEvent('desirerp-casino:setBalance', source)
--     end
...
--         TriggerEvent('desirerp-casino:blackjack:getBalance', player.source)
--     end
-- end
...
--         else
--             TriggerClientEvent('desirerp-roulette:isSeatUsed', src, data, a1)
--         end
--     else
--         TriggerClientEvent('desirerp-roulette:isSeatUsed', src, data, a1)
--     end
...
-- RegisterNetEvent('desirerp-roulette:taskStartRoulette')
-- AddEventHandler('desirerp-roulette:taskStartRoulette', function(rouletteIndex, chairId)
--         local source = source

--         local xPlayer = exports["desirerp-base"]:getModule("Player"):GetUser(source)
--         if xPlayer then
--             if activeRoulettes[rouletteIndex] == nil then
...
--                 TriggerClientEvent('desirerp-roulette:openRoulette', source, rouletteIndex)
--                 TriggerClientEvent('desirerp-roulette:updateChips', source)
--             else
...
-- RegisterNetEvent('desirerp-roulette:notUsing')
-- AddEventHandler('desirerp-roulette:notUsing',function(rouletteIndex)
--     local source = source
--     if activeRoulettes[rouletteIndex] ~= nil then
...
--                     TriggerClientEvent('desirerp-roulette:updateStatus', -1, rouletteIndex, v.time, v.status)
--                 end
...
--                         TriggerClientEvent('desirerp-roulette:startSpin', -1, rouletteIndex, randomSpinNumber)
--                         Citizen.Wait(15500)
...
--                             TriggerClientEvent('desirerp-roulette:updateTableBets', -1, rouletteIndex, activeRoulettes[rouletteIndex].bets)
--                         else
...
--                                 TriggerClientEvent('desirerp-roulette:updateStatus', -1, rouletteIndex, nil, nil)
--                             else
--                                 activeRoulettes[rouletteIndex].status = false
--                                 activeRoulettes[rouletteIndex].time = Config.RouletteStart
--                                 activeRoulettes[rouletteIndex].WinningBetIndex = nil
...
--         local xPlayer = exports["desirerp-base"]:getModule("Player"):GetUser(betData.playerSrc)
--         if xPlayer then
...
--         if chairId ~= nil then
--             TriggerClientEvent('desirerp-roulette:playWinAnim', targetSrc, chairId)
--         end
--     end
...
--         local chairId = getPlayerTableSeat(targetSrc)
--         if chairId ~= nil then
--             TriggerClientEvent('desirerp-roulette:playLossAnim', targetSrc, chairId)
--         end
--     end
-- end
...
-- RegisterNetEvent('desirerp-roulette:taskBetRoulette')
-- AddEventHandler('desirerp-roulette:taskBetRoulette', function(rouletteIndex, betId, betAmount)
--     local source = source
--     local xPlayer = exports["desirerp-base"]:getModule("Player"):GetUser(source)
--     if xPlayer then
--         if activeRoulettes[rouletteIndex] ~= nil then
...
--                     TriggerClientEvent('desirerp-roulette:playBetAnim', xPlayer.source, chairId)
--                 end
--             else
