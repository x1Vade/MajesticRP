...
--             label = "Smash!",
--             icon = "hammer",
--             event = "desirerp-heists:safe:rob",
--             parameters = {}
--         }
--     },
--     options = {
    ...
    data = {
        {
            ...
            label = " Use Gas Pump",
            icon = "gas-pump",
            event = "desirerp-fuel:SelectFuel",
            parameters = {}
        }
    },
    options = {
        ...
        isEnabled = function(pEntity, pContext)
            return not exports['desirerp-fuel']:hasNozle()
        end
    }
}
    ...
    data = {
        {
            ...
            label = "Return Hose",
            icon = "hand-holding",
            event = "desirerp-fuel:ReturnNozel",
            parameters = {}
        }
    },
    options = {
        distance = { radius = 1.7 },
        isEnabled = function(pEntity, pContext)
            return exports['desirerp-fuel']:hasNozle()
        end
    }
}
    ...
    data = {
        {
            ...
            label = "Yoga",
            icon = "circle",
            event = "desirerp-healthcare:yoga",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            label = "Weights",
            icon = "circle",
            event = "desirerp-healthcare:exercise",
            parameters = {}
        }
    },
    options = {
...
--             label = "Smoke Machine",
--             icon = "circle",
--             event = "desirerp-stripclub:smokemachine",
--             parameters = {}
--         }
--     },
--     options = {
    ...
    data = {
        {
            ...
            label = "Steal!",
            icon = "hammer",
            event = "desirerp-usableprops:stealStopSign",
            parameters = {}
        }
    },
    options = {
...
--[[Entries[#Entries + 1] = {
    ...
    data = {
        {
            id = 'desirerp-usableprops:stealStopSign',
            label = "Steal!",
            icon = "hammer",
            event = "desirerp-usableprops:stealStopSign",
            parameters = {}
    ...
    data = {
        {
            ...
            label = "Skin Animal",
            icon = "circle",
            event = "desirerp-hunting:skinAnimal",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "cannabis",
            event = "desirerp-weed:checkPlant",
            parameters = {}
        }
    },
    options = {
  ...
  data = {
      {
          ...
          icon = "archive",
          event = "desirerp-beekeeping:checkBeehive",
          parameters = {}
      }
  },
  options = {
  ...
  data = {
      {
          ...
          event = "desirerp-beekeeping:harvestHive",
          parameters = {}
      }
  },
  options = {
