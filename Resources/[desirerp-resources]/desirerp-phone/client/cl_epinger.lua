...
AddEventHandler("phone:ping:receive", function(pCoords, pSrc, pCharacterName)
  ...
  --   name = pCharacterName
  -- })
  data = {amount = "", sellerID = sId, pType = 'ping_noti'}
  phoneBillNotification("phoneping", data, pCharacterName)
end)

RegisterNUICallback("desirerp-ui:pingSend", function(data, cb)
...
RegisterNUICallback("desirerp-ui:pingAccept", function(data, cb)
...
RegisterNUICallback("desirerp-ui:pingReject", function(data, cb)
