...
isEnabled = function(pEntity, pContext)
    return not IsDisabled() and IsPedInAnyVehicle(PlayerPedId(), false) and exports['desirerp-vehicles']:hasKey(GetVehicleNumberPlateText(GetVehiclePedIsIn(PlayerPedId()))) 
end
}
...
GeneralEntries[#GeneralEntries+1] = {
  data = {
      id = "desirerp-garages:pd_heli",
      title = "Vehicle List",
      icon = "#vehicle-vehicleList",
      event =  "desirerp-garages:pd_heli" 
  },
  isEnabled = function()
...
-- --         event = "desirerp-doors:doorKeyFob"
-- --     },
-- --     isEnabled = function(pEntity, pContext)
-- --         return not IsDisabled() and IsPedInAnyVehicle(PlayerPedId(), false) and exports["desirerp-inventory"]:hasEnoughOfItem("keyfob", 1, false)
-- --     end
-- -- }
...
--   },
--   isEnabled = function(pEntity, pContext)
--       return not IsDisabled() and polyChecks.vanillaUnicorn.isInside and not exports["desirerp-flags"]:HasPedFlag(PlayerPedId(), 'isPoledancing')
--   end
-- }
...
--   },
--   isEnabled = function(pEntity, pContext)
--       return not IsDisabled() and polyChecks.vanillaUnicorn.isInside and exports["desirerp-flags"]:HasPedFlag(PlayerPedId(), 'isPoledancing')
--   end
-- }
...
GeneralEntries[#GeneralEntries+1] = {
  data = {
    ...
    title = "10-13A",
    icon = "#police-dead",
    event = "desirerp-police:tenThirteenA",
  },
  isEnabled = function(pEntity, pContext)
...
GeneralEntries[#GeneralEntries+1] = {
  data = {
    ...
    title = "10-13B",
    icon = "#police-dead",
    event = "desirerp-police:tenThirteenB",
  },
  isEnabled = function(pEntity, pContext)
    return isDead and (isPolice or isDoc)
  end
...
GeneralEntries[#GeneralEntries+1] = {
  data = {
    ...
    title = "10-14A",
    icon = "#ems-dead",
    event = "desirerp-police:tenForteenA",
  },
  isEnabled = function(pEntity, pContext)
...
GeneralEntries[#GeneralEntries+1] = {
  data = {
    ...
    title = "10-14B",
    icon = "#ems-dead",
    event = "desirerp-police:tenForteenB",
  },
  isEnabled = function(pEntity, pContext)
    return isDead and isMedic
  end
...
isEnabled = function()
  return isAtHouseGarage and exports["desirerp-garages"]:NearVehicle("Distance") and not IsPedInAnyVehicle(PlayerPedId(), false) and not isDead
end
}]]
 ...
 GeneralEntries[#GeneralEntries+1] = {
   data = {
     ...
     title = "Get up",
     icon = "#obj-chair",
     event = "desirerp-emotes:sitOnChair"
   },
   isEnabled = function(pEntity, pContext)
     return not isDead and exports["desirerp-flags"]:HasPedFlag(PlayerPedId(), 'isSittingOnChair')
   end
 }
...
--       event = "desirerp-housing:rent"
--   },
--   isEnabled = function(pEntity, pContext)
--       return not isDead and exports["desirerp-housing"]:canRent()
--   end
-- }
...
GeneralEntries[#GeneralEntries+1] = {
  data = {
      ...
      icon = "#property-enter",
      event = "desirerp-housing:enterBUILDINGCMON",
      parameters = false,
  },
  isEnabled = function(pEntity, pContext)
      local isNear, propertyId = exports["desirerp-housing"]:isNearProperty()
...
GeneralEntries[#GeneralEntries+1] = {
  ...
  isEnabled = function(pEntity, pContext)
      local isNear, propertyId = exports["desirerp-housing"]:isNearProperty()
      return not isDead and isNear and exports["desirerp-housing"]:isBeingRobbed(propertyId)
  end
}
...
GeneralEntries[#GeneralEntries+1] = {
  data = {
      ...
      event = "desirerp-dispatch:openDispatch"
  },
  isEnabled = function()
...
GeneralEntries[#GeneralEntries+1] = {
  data = {
    ...
    title = "Vehicle List",
    icon = "#vehicle-vehicleList",
    event = "desirerp-garages:open2"
},
isEnabled = function()
 print(exports['desirerp-housing']:ownsThisHouseHmm())
  return isAtHouseGarage and not IsPedInAnyVehicle(PlayerPedId(), false) and not isDead
end
}
...
GeneralEntries[#GeneralEntries+1] = {
  data = {
      ...
      icon = "#vehicle-options-vehicle",
      event = "desirerp-base:leaveDonatorShop"
  },
  isEnabled = function(pEntity, pContext)
      return not isDead and exports['desirerp-base']:isInDonatorShopBuilding()
  end
}
...
-- -- end)
 ...
 AddEventHandler("vehicle:openRifleRack", function()
	...
	if exports["isPed"]:isPed("myJob") == 'police' or exports["isPed"]:isPed("myJob") == 'sheriff' or exports["isPed"]:isPed("myJob") == 'ranger' or exports["isPed"]:isPed("myJob") == 'state' then
		local finished = exports["desirerp-taskbar"]:taskBar(1000,"Unlocking...",false,true)
...
AddEventHandler("desirerp-menu:dashCamAttached", function(pVehicleNetId, pEnabled)
...
GeneralEntries[#GeneralEntries+1] = {
  data = {
      ...
      event = "desirerp-gopro:removeDashCam",
  },
  isEnabled = function()
    local veh = GetVehiclePedIsIn(PlayerPedId())
