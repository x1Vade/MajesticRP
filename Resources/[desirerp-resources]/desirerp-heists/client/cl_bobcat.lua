...
-- RegisterNetEvent('desirerp-bobcat:firstdoor')
-- AddEventHandler('desirerp-bobcat:firstdoor', function()
--     local player = GetEntityCoords(PlayerPedId())
--     local distance = #(vector3(882.208, -2258.1, 30.541439) - player)
--     local pd = RPC.execute("desirerp-police:getActiveUnits")
--     if pd >= 5 then
--         if distance < 1.5 then
--             if exports["desirerp-inventory"]:hasEnoughOfItem("thermitecharge", 1) then
--                 frontdoor()
--                 TriggerServerEvent('desirerp-heists:bobcatLog')
--                 TriggerEvent("inventory:removeItem", "thermitecharge", 1)
--                 exports['desirerp-thermite']:OpenThermiteGame(function(success)
--                     if success then
--                         TriggerServerEvent('desirerp-doors:change-lock-state', 272, false) 
--                         TriggerServerEvent("desirerp-doors:change-lock-state", 273, false)
--                         TriggerEvent('desirerp-dispatch:bobcat')
...
-- RegisterNetEvent('desirerp-bobcat:seconddoor')
-- AddEventHandler('desirerp-bobcat:seconddoor', function()
-- local player = GetEntityCoords(PlayerPedId())
...
--                         --Door IDS
--                         TriggerServerEvent("desirerp-doors:change-lock-state", 274, false)
--                         TriggerEvent('desirerp-dispatch:bobcat')
--                         Citizen.Wait(3000)
--                     else
--                         Citizen.Wait(2000)
...
-- RegisterNetEvent('desirerp-heists:bobcat_armed_door')
-- AddEventHandler('desirerp-heists:bobcat_armed_door', function()
...
--             TriggerEvent('desirerp-heists:bobcat_explosion_ped')
--             FreezeEntityPosition(PlayerPedId(), true)
--             FreezeEntityPosition(PlayerPedId(), false)
--             TriggerServerEvent("desirerp-doors:change-lock-state", 276, false)
--             TriggerServerEvent("desirerp-doors:change-lock-state", 277, false)
--         end
--     else
--         TriggerEvent('DoLongHudText', 'Not enough cops on duty', 2)
--     end
...
--     TriggerEvent('DoLongHudText', "Success!", 1)
--     TriggerServerEvent("desirerp-doors:change-lock-state", 275, false)
--     TriggerServerEvent("desirerp-doors:change-lock-state", 276, false)
--     TriggerEvent('desirerp-dispatch:bobcat')
-- end)
...
-- RegisterNetEvent('desirerp-bobcat:bubbles')
...
--     TriggerServerEvent('desirerp-heists:bobcatLog')
--     TriggerServerEvent('desirerp-bobcat:blow_door')
-- end)

-- RegisterNetEvent('desirerp-heists:bobcat_explosion_ped')
-- AddEventHandler('desirerp-heists:bobcat_explosion_ped', function()
...
-- RegisterNetEvent('desirerp-heists:explosion_ped_walk') -- PED WALK
-- AddEventHandler('desirerp-heists:explosion_ped_walk', function()
--     TriggerEvent('desirerp-dispatch:bobcat')
...
-- 	TriggerServerEvent("desirerp-bobcat:request_door")
-- end)
...
--     TriggerServerEvent("desirerp-bobcat:bubbles")
--     -- TriggerEvent("lumo:propcreate")
--     Wait(1500)
-- end)


-- RegisterNetEvent('desirerp-bobcat:search_crate_1unchecked') -- PED WALK
-- AddEventHandler('desirerp-bobcat:search_crate_1unchecked', function()
--     TriggerServerEvent("desirerp-bobcat:search_crate_1")
-- end)

-- RegisterNetEvent('desirerp-bobcat:search_crate_2unchecked') -- PED WALK
-- AddEventHandler('desirerp-bobcat:search_crate_2unchecked', function()
--     TriggerServerEvent("desirerp-bobcat:search_crate_2")
-- end)

-- RegisterNetEvent('desirerp-bobcat:search_crate_3unchecked') -- PED WALK
-- AddEventHandler('desirerp-bobcat:search_crate_3unchecked', function()
--     TriggerServerEvent("desirerp-bobcat:search_crate_3")
-- end)

-- RegisterNetEvent('desirerp-bobcat:search_crate_1') 
-- AddEventHandler('desirerp-bobcat:search_crate_1', function()
--     FreezeEntityPosition(GetPlayerPed(-1),true)
--     TriggerEvent("doAnim","search")
--     TriggerEvent('desirerp-dispatch:bobcat')
--     local finished = exports["desirerp-taskbar"]:taskBar(30000,"Looting")
--     if finished == 100 then
--         TriggerEvent('desirerp-heists:bobcat_loot')
...
-- RegisterNetEvent('desirerp-bobcat:search_crate_2') 
...
-- RegisterNetEvent('desirerp-bobcat:search_crate_3')
...
-- RegisterNetEvent('desirerp-heists:bobcat_loot')
-- AddEventHandler('desirerp-heists:bobcat_loot', function()
...
--         TriggerEvent('desirerp-bobcat:firstdoor')
--         TriggerEvent('desirerp-bobcat:seconddoor') 
--     end
-- end)

-- AddEventHandler("desirerp-inventory:itemUsed", function(item)
--     if item == "bobcatsecuritycard" then
--         TriggerEvent('desirerp-heists:bobcat_armed_door')
--     end
-- end)
...
-- exports["desirerp-polytarget"]:AddCircleZone("desire_bobcat_loot_1",  vector3(886.61, -2287.32, 29.92), 1.0, {
--     useZ = true,
-- })

-- exports["desirerp-polytarget"]:AddCircleZone("desire_bobcat_loot_3",  vector3(881.4, -2282.62, 30.42), 1.0, {
--     useZ = true,
-- })

-- exports["desirerp-polytarget"]:AddCircleZone("desire_bobcat_loot_2",  vector3(882.49, -2286.17, 30.37), 1.0, {
--     useZ = true,
-- })

-- exports["desirerp-interact"]:AddPeekEntryByPolyTarget('desire_bobcat_loot_1', {{
--     id = "desire_bobcat_loot_1",
--     event = "desirerp-bobcat:search_crate_1unchecked",
--     icon = "circle",
--     label = "Loot!",
--     paramers = {},
-- }}, { distance = { radius = 3.5 }  })

-- exports["desirerp-interact"]:AddPeekEntryByPolyTarget('desire_bobcat_loot_2', {{
--     id = "desire_bobcat_loot_2",
--     event = "desirerp-bobcat:search_crate_2unchecked",
--     icon = "circle",
--     label = "Loot!",
--     paramers = {},
-- }}, { distance = { radius = 3.5 }  })

-- exports["desirerp-interact"]:AddPeekEntryByPolyTarget('desire_bobcat_loot_3', {{
--     id = "desire_bobcat_loot_3",
--     event = "desirerp-bobcat:search_crate_3unchecked",
--     icon = "circle",
--     label = "Loot!",
--     paramers = {},
-- }}, { distance = { radius = 3.5 }  })