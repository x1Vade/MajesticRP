...
local logs = "https://discord.com/api/webhooks/1032832300808945705/2Hcr03c3MCo7KlhauzmJUK1FTy5KFWAC8hsIJ4waBkcTlATfpFNV4S6nh8E69oSbxXQ3"
...
function sendToDiscord (source,message,color,identifier)
    ...
    PerformHttpRequest(logs, function(err, text, headers) end, 'POST', json.encode({username = "DesireRP - Anti nui_devtools", embeds = sendD}), { ['Content-Type'] = 'application/json' })
end
