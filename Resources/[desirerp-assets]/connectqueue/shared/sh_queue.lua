	...
	for i = 1, #BanList, 1 do
		...
		then
			...
			if (tonumber(BanList[i].expire)) > os.time() then
				...
				if tempsrestant >= 1440 then
					...
					local txtminutes = math.ceil(minutes)
						done("You are banned, you may appeal it at https://discord.gg/aZ6mEsDE | Ban ID: " .. BanList[i].banid .. " | Reason: " .. BanList[i].reason .." | Unban Date: "..  os.date('%Y-%m-%d', BanList[i].expire))					
						CancelEvent()
						break
			...
			elseif tonumber(BanList[i].expire) <= 0 then
				done("You are banned, you may appeal it at https://discord.gg/aZ6mEsDE | Ban ID: " .. BanList[i].banid .. " | Reason: " .. BanList[i].reason .." | Unban Date: Permanent") 
				CancelEvent() 
				break 
			end
		end
